...
<head>
  ...
  <!--Favicon-->
  <link rel="shortcut icon" href="<?php echo get_template_directory_uri();?>/images/14-01.svg" type="image/x-icon">
  <link rel="icon" href="<?php echo get_template_directory_uri();?>/images/14-01.svg" type="image/x-icon">
  <!-- Responsive -->
            ...
            <div class="topbar-widgets clearfix">
              ...
              <div class="widget">
                ...
                <div class="pull-right">
                      <div class="Call_us">Передзвоніть нам!</div>
                    <div>
